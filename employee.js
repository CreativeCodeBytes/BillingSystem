document.addEventListener('DOMContentLoaded', function() {
    ...
    // if (loginAs !== 'employee' || loginId !== 'employee') {
    ...
    function displayMyBills(searchTerm = '') {
        ...
        document.querySelectorAll('.view-bill-btn, .print-bill-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                const index = parseInt(this.getAttribute('data-index'));
                const action = this.classList.contains('view-bill-btn') ? viewBill : printBill;
                action(index);
            });
        });
    }
