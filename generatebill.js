...
function calculateTotal() {
    ...
    document.getElementById("total-price").innerText = `Subtotal: ₹${subtotal.toFixed(2)} | GST (18%): ₹${gstAmount.toFixed(2)} | Total: ₹${totalPrice.toFixed(2)}`;
}
...
function generateInvoice() {
  ...
  `;
    invoiceList.appendChild(subtotalLi);

    // Add GST to the invoice
...
function clearAll() {
    ...
    renderItems(); // Clear the list on the screen
    document.getElementById("total-price").innerText = ""; // Clear the total price
